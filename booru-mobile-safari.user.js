...
Make sure you have modified Tampermonkey's "Download Mode" to "Browser API".`;
  ...
  var _sfc_main$b = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      ...
      return { __sfc: true, locationHost, isDanbooru, isGelbooru, danbooruShortcuts, gelbooruShortcuts, iconProxy, konachanIcon, rule34Icon, sites: sites2, openSite, mdiClose, mdiFire, mdiHome, mdiImageMultiple, mdiShuffle, store };
    }
  });
  ...
  var _sfc_render$5 = function render() {
    ...
    } } }, [_setup.isVideo ? [_setup.isVideoShow ? _c(_setup.DPlayer, { style: `width: ${_setup.imageSelectedWidth > _setup.imageSelected.width ? _setup.imageSelected.width : _setup.imageSelectedWidth}px`, attrs: { "options": { theme: "#8E24AA", autoplay: true, loop: true, video: { url: _setup.imageSelected.fileUrl } } } }) : _vm._e()] : _c("div", { class: { img_scale_scroll: _setup.scaleOn, img_scale_normal: !_setup.scaleOn }, attrs: { "draggable": "false" } }, [_c("v-row", { directives: [{ name: "show", rawName: "v-show", value: _setup.imgLoading, expression: "imgLoading" }], staticClass: "img_detail_loading" }, [_setup.showPreviewThumb && !_setup.scaleOn ? _c("img", { attrs: { "src": _setup.imgLasySrc, "width": _setup.imageSelectedWidth, "alt": "" } }) : _vm._e(), _c("v-progress-circular", { attrs: { "size": 100, "width": 6, "indeterminate": "", "color": "deep-purple" } })], 1), !_setup.scaleOn ? _c("img", { staticClass: "img_detail_sample", style: { opacity: _setup.imgLoading ? 0 : 1 }, attrs: { "draggable": "false", "alt": "", "src": _setup.imgSrc, "width": _setup.imageSelectedWidth }, on: { "click": function($event) {
      $event.stopPropagation();
