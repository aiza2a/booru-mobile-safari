...
Make sure you have modified Tampermonkey's "Download Mode" to "Browser API".`;
  ...
  var _sfc_render$5 = function render() {
    ...
    } } }, [_setup.showPreviewThumb && !_setup.scaleOn ? _c("img", { attrs: { "src": _setup.imgLasySrc, "width": _setup.imageSelectedWidth, "alt": "" } }) : _vm._e(), _c("v-progress-circular", { attrs: { "size": 100, "width": 6, "indeterminate": "", "color": "deep-purple" } })], 1), !_setup.scaleOn ? _c("img", { staticClass: "img_detail_sample", style: { opacity: _setup.imgLoading ? 0 : 1 }, attrs: { "draggable": "false", "alt": "", "src": _setup.imgSrc, "width": _setup.imageSelectedWidth }, on: { "click": function($event) {
      $event.stopPropagation();
