...
Make sure you have modified Tampermonkey's "Download Mode" to "Browser API".`;
  ...
  var _sfc_render$4 = function render() {
    ...
    return _setup.showImageList ? _c("div", { style: _setup.settings.masonryLayout === "virtual" ? "height:93vh" : "" }, [_setup.settings.masonryLayout === "virtual" ? _c("virtual-waterfall", { staticClass: "virtual-waterfall", class: { "wf-no-fit-screen": _setup.notFitScreen }, staticStyle: { "min-height": "93vh" }, attrs: { "gap": 10, "preload-screen-count": [1, 1], "item-min-width": 300, "items": _setup.store.imageList, "max-column-count": _setup.virtualMaxCol, "calc-item-height": _setup.calcItemHeight }, scopedSlots: _vm._u([{ key: "default", fn: function({ item, index }) {
      return [_c("div", { staticClass: "posts-image-card" }, [_c("img", { staticClass: "post-image-v", attrs: { "alt": "", "loading": "lazy", "src": _setup.getImgSrc(item), "role": "button", "tabindex": "0", "draggable": "false" }, on: { "dragstart": function($event) {
    ...
    } }], null, false, 811303924) }) : _c("wf-layout", _vm._l(_setup.store.imageList, function(image, index) {
      return _c("v-card", { key: index, staticClass: "posts-image-card", style: _setup.imgCardStyle(image) }, [_setup.settings.masonryLayout === "justified" ? [_c("img", { staticClass: "post-image", attrs: { "alt": "", "loading": "lazy", "src": _setup.getImgSrc(image), "role": "button", "tabindex": "0", "draggable": "false" }, on: { "dragstart": function($event) {
        $event.preventDefault();
      }, "click": function($event) {
        return _setup.onImageClick(index);
      }, "touchstart": function($event) {
