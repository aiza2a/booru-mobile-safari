...
Make sure you have modified Tampermonkey's "Download Mode" to "Browser API".`;
  ...
  var _sfc_render$5 = function render() {
    ...
    return _c("v-dialog", { attrs: { "fullscreen": "" }, model: { value: _setup.store.showImageSelected, callback: function($$v) {
    ...
    } } }, [_c("v-list-item-title", [_vm._v(_vm._s(_vm.$t("VpuyxZtIoDF9-YyOm0tK_")))]), _c("v-list-item-subtitle", { domProps: { "textContent": _vm._s(_setup.imageSelected.fileDownloadText) } })], 1)], 1)], 1)], 1) : _vm._e(), _c("v-progress-circular", { directives: [{ name: "show", rawName: "v-show", value: _setup.downloading, expression: "downloading" }], staticClass: "ml-1 mr-2", attrs: { "indeterminate": "", "color": "primary" } }), _c("v-tooltip", { attrs: { "bottom": "" }, scopedSlots: _vm._u([{ key: "activator", fn: function({ on, attrs }) {
      return [_c("v-btn", _vm._g(_vm._b({ staticClass: "mr-1 mobile-primary-share", attrs: { "fab": "", "small": "" }, on: { "click": function($event) {
        $event.stopPropagation();
        return _setup.sharePost(_setup.imageSelected);
      } } }, "v-btn", attrs, false), on), [_c("v-icon", [_vm._v(_vm._s(_setup.mdiShareVariant))])], 1)];
    } }]) }, [_c("span", [_vm._v("\u5206\u4EAB\u4F5C\u54C1\u94FE\u63A5")])]), _setup.notPartialSupportSite && _setup.notR34Fav ? _c("v-tooltip", { attrs: { "bottom": "" }, scopedSlots: _vm._u([{ key: "activator", fn: function({ on, attrs }) {
      return [_c("v-btn", _vm._g(_vm._b({ staticClass: "mr-1", attrs: { "fab": "", "small": "" }, on: { "click": function($event) {
        $event.stopPropagation();
      ...
      $event.stopPropagation();
    } } }, [_c("v-btn", { attrs: { "icon": "", "aria-label": "\u4E0A\u4E00\u5F20" }, on: { "click": _setup.showPrevPost } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronLeft))])], 1), _c("v-btn", { attrs: { "icon": "", "aria-label": "\u6253\u5F00\u4F5C\u54C1\u9875" }, on: { "click": _setup.toDetailPage } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiLinkVariant))])], 1), _c("v-btn", { staticClass: "mobile-share-main", attrs: { "fab": "", "aria-label": "\u5206\u4EAB\u4F5C\u54C1\u94FE\u63A5" }, on: { "click": function($event) {
      return _setup.sharePost(_setup.imageSelected);
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiShareVariant))])], 1), _c("v-btn", { attrs: { "icon": "", "aria-label": "\u4E0B\u8F7D\u539F\u56FE" }, on: { "click": function($event) {
      return _setup.download(_setup.imageSelected.fileUrl, _setup.imageSelected.fileDownloadName);
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiDownload))])], 1), _c("v-btn", { attrs: { "icon": "", "aria-label": "\u4E0B\u4E00\u5F20" }, on: { "click": _setup.showNextPost } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronRight))])], 1)], 1) : _vm._e(), _setup.isExportTagsEnable && _setup.store.showImageSelected ? _c(_setup.PostExportTags, { attrs: { "show-dialog": _setup.isExportTagsShow, "update-show-dialog": (val) => _setup.isExportTagsShow = val, "tags": _setup.postDetail?.tags || [] } }) : _vm._e()], 1);
  };
