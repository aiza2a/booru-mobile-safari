...
Make sure you have modified Tampermonkey's "Download Mode" to "Browser API".`;
  ...
  var _sfc_render$b = function render() {
    ...
    return _c("v-app-bar", { attrs: { "app": "", "dense": "", "flat": "", "elevation": 2 } }, [_c("v-app-bar-nav-icon", { on: { "click": function($event) {
    ...
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiShuffle))])], 1)] : _vm._e(), _setup.isMobile && _setup.isSupportTagSearch ? [_c("v-menu", { attrs: { "max-width": 320, "max-height": "60vh", "transition": "slide-y-transition", "offset-y": "" }, scopedSlots: _vm._u([{ key: "activator", fn: function({ on }) {
      return [_c("div", _vm._g({ staticClass: "mobile-tag-search" }, on), [_c("v-text-field", { attrs: { "placeholder": "\u641C\u7D22\u6807\u7B7E", "append-icon": _setup.mdiMagnify, "hide-details": "", "dense": "", "clearable": "" }, on: { "input": _setup.onSearchTermInput, "click": function($event) {
        _setup.searchState.showMenu = true;
      }, "click:append": function($event) {
        return _setup.fetchTaggedPosts(_setup.searchState.searchTerm);
      ...
      }, expression: "searchState.searchTerm" } })], 1)];
    } }], null, false, 890974615), model: { value: _setup.searchState.showMenu, callback: function($$v) {
      _vm.$set(_setup.searchState, "showMenu", $$v);
    }, expression: "searchState.showMenu" } }, [_setup.searchState.searchItems.length ? _c("v-list", { staticClass: "ac_tags_list", attrs: { "dense": "" } }, _vm._l(_setup.searchState.searchItems, function(item) {
    ...
    }), 1) : _vm._e()], 1)] : _setup.isSupportTagSearch || _setup.isSankakuSite ? [_c("v-menu", { attrs: { "max-width": 200, "max-height": "80vh", "transition": "slide-y-transition", "nudge-bottom": "5px", "offset-y": "" }, scopedSlots: _vm._u([{ key: "activator", fn: function({ on }) {
    ...
    }), 1)], 1)], 1), _setup.isMobile ? _c("v-btn", { attrs: { "title": "\u6C89\u6D78\u6A21\u5F0F", "icon": "" }, on: { "click": _setup.toggleImmersive } }, [_c("v-icon", [_vm._v(_vm._s(_setup.store.isImmersive ? _setup.mdiFullscreenExit : _setup.mdiFullscreen))])], 1) : _vm._e(), _c("v-btn", { attrs: { "title": _vm.$t("UxxldE9xRwmQctrvba5Y8"), "icon": "" }, on: { "click": function($event) {
  ...
  var MobileBottomNav = __component__$9.exports;
  ...
  var _sfc_main = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      ...
      return { __sfc: true, vuetify, AppBar, NavDrawer, MobileBottomNav, SettingsDrawer, AppContainer };
    }
  });
  var _sfc_render = function render() {
    var _vm = this, _c = _vm._self._c, _setup = _vm._self._setupProxy;
    return _c("v-app", [_c(_setup.AppBar), _c(_setup.NavDrawer), _c(_setup.MobileBottomNav), _c("v-main", { attrs: { "app": "" } }, [_c(_setup.AppContainer), _c(_setup.SettingsDrawer)], 1)], 1);
  };
