...
Make sure you have modified Tampermonkey's "Download Mode" to "Browser API".`;
  ...
  var _sfc_main$d = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      ...
      return { __sfc: true, site, routeKind, capability, visible, hasLatestMode, isHome, showModeToggle, showScale, primaryMode, primaryLabel, secondaryLabel, primaryIcon, secondaryIcon, allowRange, scales, labels, scaleLabel, displayDate, rangeDisplay, today, showPicker, pickerMonth, pickerTitle, currentYear, years, canMoveNext, openPicker, resetRange, applyRange, navigate, setScale, move, onDateSelected, onMonthSelected, onYearSelected, mdiChevronLeft, mdiChevronRight, dateFilter };
    }
  });
  var _sfc_render$d = function render() {
    ...
    return _setup.visible ? _c("div", { staticClass: "mobile-date-filter" }, [_setup.showModeToggle ? _c("v-btn-toggle", { staticClass: "date-mode-toggle", attrs: { "mandatory": "", "dense": "" }, model: { value: _setup.dateFilter.mode, callback: function($$v) {
      ...
      _setup.showPicker = $$v;
    }, expression: "showPicker" } }, [_c("v-card", { staticClass: "ios-date-sheet" }, [_c("v-card-title", [_vm._v(_vm._s(_setup.pickerTitle))]), _setup.dateFilter.scale === "day" || _setup.dateFilter.scale === "week" ? _c("v-date-picker", { attrs: { "max": _setup.today, "full-width": "", "no-title": "" }, on: { "input": _setup.onDateSelected }, model: { value: _setup.dateFilter.date, callback: function($$v) {
      _vm.$set(_setup.dateFilter, "date", $$v);
    }, expression: "dateFilter.date" } }) : _setup.dateFilter.scale === "month" ? _c("v-date-picker", { attrs: { "max": _setup.today.slice(0, 7), "type": "month", "full-width": "", "no-title": "" }, on: { "input": _setup.onMonthSelected }, model: { value: _setup.pickerMonth, callback: function($$v) {
      _setup.pickerMonth = $$v;
    }, expression: "pickerMonth" } }) : _setup.dateFilter.scale === "range" ? [_c("div", { staticClass: "ios-range-picker" }, [_c("div", [_c("div", { staticClass: "range-label" }, [_vm._v("\u5F00\u59CB\u65E5\u671F")]), _c("v-date-picker", { attrs: { "max": _setup.dateFilter.rangeEnd || _setup.today, "no-title": "" }, model: { value: _setup.dateFilter.rangeStart, callback: function($$v) {
      _vm.$set(_setup.dateFilter, "rangeStart", $$v);
    }, expression: "dateFilter.rangeStart" } })], 1), _c("div", [_c("div", { staticClass: "range-label" }, [_vm._v("\u7ED3\u675F\u65E5\u671F")]), _c("v-date-picker", { attrs: { "min": _setup.dateFilter.rangeStart, "max": _setup.today, "no-title": "" }, model: { value: _setup.dateFilter.rangeEnd, callback: function($$v) {
      _vm.$set(_setup.dateFilter, "rangeEnd", $$v);
    }, expression: "dateFilter.rangeEnd" } })], 1)]), _c("v-card-actions", [_c("v-btn", { attrs: { "text": "" }, on: { "click": _setup.resetRange } }, [_vm._v("\u6E05\u9664")]), _c("v-spacer"), _c("v-btn", { attrs: { "text": "" }, on: { "click": _setup.applyRange } }, [_vm._v("\u67E5\u770B\u7ED3\u679C")])], 1)] : _c("div", { staticClass: "ios-year-picker" }, _vm._l(_setup.years, function(year) {
