...
(() => {
  ...
  var customStyle = '#loading{height:100%;width:100%;position:fixed;z-index:99999;margin-top:0;top:0}#loading p{margin:100px auto;line-height:100px;font-family:Meiryo UI,MicroHei,Microsoft YaHei UI;font-size:18px;color:#9671d7}#loading-center{width:100%;height:100%;position:relative}#loading-center-absolute{position:absolute;left:50%;top:50%;height:150px;width:150px;margin-top:-75px;margin-left:-50px}.loading-object{width:20px;height:20px;background-color:#9671d7;float:left;margin-right:20px;margin-top:65px;border-radius:50%}#loading-object_one{animation:object_one 1.5s infinite}#loading-object_two{animation:object_two 1.5s infinite;animation-delay:.25s}#loading-object_three{animation:object_three 1.5s infinite;animation-delay:.5s}@keyframes object_one{75%{transform:scale(0)}}@keyframes object_two{75%{transform:scale(0)}}@keyframes object_three{75%{transform:scale(0)}}.img_detail_loading{position:absolute;top:0;left:0;z-index:1;display:flex;justify-content:center;align-items:center;width:100%;height:100%;margin:0;pointer-events:auto;cursor:pointer}.img_detail_loading:after{content:"";position:absolute;z-index:1;top:0;left:0;width:100%;height:100%;backdrop-filter:blur(2px)}.img_detail_loading .v-progress-circular{position:absolute;z-index:10}.img_detail_loading img{object-fit:cover}.img_scale_scroll{display:block;width:100vw;height:100vh;overflow:auto;user-select:none}.img_detail_scale{display:block;margin:0 auto;user-select:none;transition:.2s}.img_detail_cont{position:relative;display:flex;justify-content:center;align-items:center;width:100%;height:100%;background-color:#212121}.theme--light .img_detail_cont{background-color:#fff}.img_scale_normal{display:flex;justify-content:center;align-items:center;height:100%}.img_detail_sample{display:block;max-width:100vw;max-height:100vh;margin:0 auto}.img_detail_btns{position:absolute;top:0;left:0;width:100%;height:100%}.img_detail_tag_list .v-slide-group__content{max-height:72vh;overflow-y:auto}::-webkit-scrollbar{width:0px}.img_detail_tag_list .v-slide-group__content::-webkit-scrollbar,.nav_drawer .v-navigation-drawer__content::-webkit-scrollbar,.img_scale_scroll::-webkit-scrollbar{width:10px!important;height:10px!important}.nav_drawer .v-list-group__items .v-list-item{padding-left:10px!important}.nav_drawer .v-list .v-list-group--active.primary--text{color:inherit!important}.img_scale_scroll::-webkit-scrollbar-track{background:#e6e6e6;border-left:1px solid #dadada}.img_detail_tag_list .v-slide-group__content::-webkit-scrollbar-thumb,.nav_drawer .v-navigation-drawer__content::-webkit-scrollbar-thumb{background:#b0b0b0;border:solid 3px #e9eef6;border-radius:7px}.theme--dark .img_detail_tag_list .v-slide-group__content::-webkit-scrollbar-thumb,.theme--dark .nav_drawer .v-navigation-drawer__content::-webkit-scrollbar-thumb{border:solid 3px #363636}.img_scale_scroll::-webkit-scrollbar-thumb{background:#b0b0b0;border:solid 3px #e6e6e6;border-radius:7px}.nav_drawer .v-navigation-drawer__content::-webkit-scrollbar-thumb:hover,.img_scale_scroll::-webkit-scrollbar-thumb:hover{background:black}.theme--dark .nav_drawer .v-navigation-drawer__content::-webkit-scrollbar-thumb:hover{background:#ddd}.poa_left_center{position:absolute;left:10px;top:50%;transform:translateY(-50%)}.poa_right_center{position:absolute;right:10px;top:50%;transform:translateY(-50%)}.v-list-item__title.title{line-height:1.2!important}.blacklist_combobox [role=combobox]{padding:0!important}.blacklist_combobox .v-chip{margin-bottom:4px!important}.preload_num{width:32px;height:30px;margin:0;padding-left:4px;border:1px solid #bbb;color:inherit;appearance:none!important;-webkit-appearance:none!important;-moz-appearance:textfield}.dplayer-notice-list,.dplayer-bezel-icon{opacity:0!important;visibility:hidden!important}.posts-image-card{margin-bottom:8px}.wf-grid .posts-image-card .v-responsive__sizer{padding-bottom:100%!important}.justified-container{display:flex!important;flex-wrap:wrap;gap:8px}.justified-container:after{content:"";flex-grow:999999999}.justified-container .posts-image-card{--jstf-w: 340;position:relative;flex-grow:calc(var(--w) * var(--jstf-w) / var(--h));width:calc(1px * var(--w) * var(--jstf-w) / var(--h));margin-bottom:0!important;padding-bottom:0!important;background-color:#dcdcdc;content-visibility:auto;contain-intrinsic-size:auto 300px}@media screen and (max-width: 500px){.justified-container .posts-image-card{--jstf-w: 240}}.justified-container .posts-image-card:before{content:"";display:block;padding-bottom:calc(var(--h) / var(--w) * 100%)!important}.justified-container .post-image{position:absolute;top:0;left:0;width:100%;height:100%;border-radius:4px;vertical-align:bottom;object-fit:cover}.theme--light .v-app-bar{background-color:#fff!important}.site_icon{width:20px;height:20px;object-fit:cover}.theme--light .sel_menu_btn{min-height:32px;padding:0 16px;background-color:#ba68c833!important;border-width:0;border-radius:4px;font-weight:600!important;color:#8e24aa!important;text-transform:none;box-shadow:none!important}.theme--light .nav_drawer .sel_menu_btn .v-icon{color:#8e24aa!important}.theme--light .sel_menu_btn .v-btn__content{line-height:1!important}.theme--light .nav_drawer .v-icon,.theme--light .nav_drawer .v-btn--icon,.theme--light .v-app-bar .v-icon,.theme--light .v-app-bar .v-btn--icon{color:#000000de!important}.posts-image-wh{position:absolute;bottom:0;left:0;padding:0 8px;font-size:14px;color:#fff;background:rgba(0,0,0,.4);border-top-right-radius:4px}.posts-image-actions{position:absolute;bottom:0;right:0;width:100%;padding:2px;text-align:center;background:rgba(0,0,0,.4);backdrop-filter:blur(10px);opacity:0;visibility:hidden;transition:.4s}.posts-image-card:hover .posts-image-actions{opacity:1;visibility:visible}.posts-image-checkbox{position:absolute;top:5px;left:5px;width:28px;padding:2px;height:28px;border-radius:2px;background:rgba(0,0,0,.4);backdrop-filter:blur(10px);opacity:0;visibility:hidden;transition:.4s}.posts-image-checkbox:has(input[aria-checked="true"]),.posts-image-card:hover .posts-image-checkbox{opacity:1;visibility:visible}.posts-image-checkbox .v-input--selection-controls__ripple .primary--text,.posts-image-checkbox .v-input--selection-controls__input .v-icon{color:#fff!important}.posts-image-type{position:absolute!important;top:0;right:0;padding:2px 4px;border-bottom-left-radius:4px;background:rgba(0,0,0,.4);backdrop-filter:blur(10px)}.theme--light .posts-image-type{background:rgba(255,255,255,.4)}@media screen and (min-width: 768px){.wf-no-fit-screen{max-width:62.5vw;margin:16px auto}}.virtual-waterfall>[data-index]{box-shadow:0 3px 1px -2px #0003,0 2px 2px #00000024,0 1px 5px #0000001f;border-radius:4px}.theme--light .v-app-bar{box-shadow:none!important;background:#f6f8fc!important}.theme--light .v-app-bar,.theme--light .v-app-bar .v-toolbar__content{height:64px!important}.theme--light .v-main{padding-top:64px!important}.theme--light .v-app-bar .v-toolbar__title+input{width:50px!important;background-color:#eaf1fb!important;border-radius:24px!important}.theme--light .nav_drawer .v-icon,.theme--light .nav_drawer .v-btn--icon,.theme--light .v-app-bar .v-icon,.theme--light .v-app-bar .v-btn--icon{color:#5f6368!important}.theme--light .app-bar-tag-input .v-input .v-input__slot:before,.theme--light .app-bar-tag-input .v-input .v-input__slot:after{display:none}.theme--light .app-bar-tag-input .v-input input{padding:5px 44px 5px 10px;background-color:#eaf1fb;min-height:48px;border-radius:24px}.theme--light .app-bar-tag-input:not([style*="none"])+.v-btn{position:relative;left:-50px}.theme--light.v-list,.theme--light.v-navigation-drawer{background:#e9eef6!important}.theme--dark .img_detail_btn_color .v-chip:not(.img_detail_tag),.theme--dark .img_detail_btn_color .v-chip.tag_type_general,.theme--dark .img_detail_btn_color .v-btn{background-color:#ba68c8b3!important;border-color:#ba68c8b3!important}.theme--light .img_detail_btn_color .v-chip:not(.img_detail_tag),.theme--light .img_detail_btn_color .v-chip:not(.img_detail_tag) .v-icon,.theme--light .img_detail_btn_color .v-chip.tag_type_general,.theme--light .img_detail_btn_color .v-btn{background-color:#c2e7ff!important;border-color:#c2e7ff!important;color:#1a73e8!important;box-shadow:none!important;font-weight:500}.img_detail_btn_color .v-chip.img_detail_tag{font-weight:500}.theme--light .v-btn:not(.v-btn--icon,.v-btn--fab,.v-btn--text,.v-date-picker-table__current){padding-bottom:2px;border-radius:10px;color:#001d35;background-color:#c2e7ff}.theme--light .refresh_posts_btn{box-shadow:0 1px 2px #0000,0 1px 3px 1px #0000;background-color:#c2e7ff!important;border-color:#c2e7ff!important;color:#001d35}.theme--light .img_detail_loading .v-progress-circular{color:#1a73e8!important;caret-color:#1a73e8!important}.theme--light .blacklist_combobox .v-input__slot{padding-left:8px!important}.theme--light .v-text-field--outlined{border-radius:20px}.fancybox__caption{display:none;padding:12px 24px!important}.v-toolbar.img_detail_btn_color{backdrop-filter:none!important}.virtual-waterfall .posts-image-card{width:100%;height:100%;margin-bottom:0;background:gainsboro;border-radius:4px!important}.virtual-waterfall .post-image-v{width:100%;height:100%;object-fit:cover;border-radius:4px!important}.virtual-waterfall .posts-image-type{border-top-right-radius:4px}.virtual-waterfall .posts-image-actions{border-bottom-left-radius:4px;border-bottom-right-radius:4px}html:has(#app.theme--dark){background:#121212}@media screen and (max-width: 1200px){.nav_drawer{height:100dvh!important}.nav_drawer .v-navigation-drawer__content{padding-bottom:9vh}}.img_meta_tag_list{position:absolute;top:35px;width:200px}.img_meta_tag_list .img_detail_tag.tag_type_artist{color:#c97000!important;background-color:#ffdcb0!important;border-color:#ffdcb0!important}.img_meta_tag_list .img_detail_tag.tag_type_copyright{color:#ae3fc1!important;background-color:#f9d5ff!important;border-color:#f9d5ff!important}.img_meta_tag_list .img_detail_tag.tag_type_character{color:#0c9312!important;background-color:#c4ffc7!important;border-color:#c4ffc7!important}.true-masonry .posts-image-card{height:fit-content;max-height:unset!important;margin-bottom:0!important}.d-flex-y{display:flex;align-items:center;flex-wrap:wrap}.d-flex-col{display:flex;flex-direction:column}.export-tags-setting{display:flex;align-items:center;flex-wrap:wrap;gap:20px}.export-tags-setting .v-messages{display:none}.export-tags-setting>.v-input{margin-top:0}.export-tags-wght-inp{width:45px;height:24px;margin-left:4px;background-color:#eaf1fb;border-radius:4px;border:1px solid rgb(187,187,187);color:inherit;text-align:center}.d-flex-col .v-chip--active:before,.d-flex-col .v-chip--active:hover:before,.d-flex-col .v-chip:focus:before{display:none}.img-detail-toolbar{position:absolute;top:0;width:100%;z-index:10}.img-detail-toolbar.detail-buttons-bottom{top:unset;bottom:12px}.img-detail-tags{position:absolute;z-index:10;bottom:12px;padding:0 12px}.img-detail-tags.detail-buttons-bottom{top:12px;bottom:unset}.img-detail-toolbar.detail-buttons-bottom .img_meta_tag_list{top:0;transform:translateY(-95%)}.settings_drawer .v-list-item__subtitle{white-space:normal}.theme--dark.v-application,.theme--dark .v-application--wrap,html:has(#app.theme--dark){background:#08090c!important}.theme--dark .v-app-bar,.theme--dark .mobile-bottom-nav,.theme--dark .v-navigation-drawer,.theme--dark .settings_drawer{background:rgba(15,17,22,.94)!important;border-color:#ffffff14!important;backdrop-filter:saturate(140%) blur(18px);-webkit-backdrop-filter:saturate(140%) blur(18px)}.theme--dark .posts-image-card{background:#14161b!important;box-shadow:0 1px #ffffff0a!important}.mobile-bottom-nav{padding-bottom:env(safe-area-inset-bottom);height:calc(58px + env(safe-area-inset-bottom))!important;border-top:1px solid rgba(255,255,255,.08)}.mobile-bottom-nav .v-btn{min-width:56px!important;height:58px!important}.mobile-card-share{position:absolute;z-index:4;right:5px;bottom:5px;border-radius:999px;background:rgba(0,0,0,.48);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px)}.mobile-detail-nav{position:fixed;z-index:30;right:12px;bottom:calc(10px + env(safe-area-inset-bottom));left:12px;display:flex;align-items:center;justify-content:space-around;min-height:58px;padding:6px 8px;border:1px solid rgba(255,255,255,.1);border-radius:22px;color:#f7f7fb;background:rgba(15,17,22,.88);box-shadow:0 12px 32px #0006;backdrop-filter:blur(20px) saturate(150%);-webkit-backdrop-filter:blur(20px) saturate(150%)}.mobile-detail-nav .mobile-share-main{color:#20172a!important;background:#d8b4fe!important}@media screen and (max-width: 959px),(pointer: coarse){.v-application .v-app-bar{padding-top:env(safe-area-inset-top);height:calc(52px + env(safe-area-inset-top))!important}.v-application .v-app-bar .v-toolbar__content{height:52px!important;padding:0 4px}.v-main{padding-bottom:calc(62px + env(safe-area-inset-bottom))!important}.posts-image-actions{display:none!important}.posts-image-card{margin-bottom:6px!important;border-radius:6px!important;touch-action:manipulation}.wf-layout,.justified-container{gap:6px!important}.img-detail-toolbar:not(.detail-buttons-bottom),.img-detail-toolbar.detail-buttons-bottom{top:calc(4px + env(safe-area-inset-top));bottom:unset;padding:0 4px}.img-detail-toolbar .v-btn,.img-detail-toolbar .v-progress-circular,.img-detail-tags{display:none!important}.img_detail_cont,.img_detail_sample{touch-action:pan-y pinch-zoom}}@media screen and (min-width: 960px){.mobile-card-share,.mobile-detail-nav,.mobile-bottom-nav{display:none!important}}.mobile-site-drawer .drawer-title-row{min-height:76px}.mobile-site-drawer .site-switch-list{padding:8px}.mobile-site-drawer .site-switch-list .v-list-item{min-height:58px;margin-bottom:4px;border-radius:12px}.mobile-site-drawer .site-switch-active{color:#e9d5ff!important;background:rgba(168,85,247,.22)!important}.mobile-site-drawer .site_icon{width:28px;height:28px;border-radius:6px;object-fit:cover}.posts-image-card img,.posts-image-card .v-image,.img_detail_sample,.img_detail_scale{-webkit-touch-callout:none!important;-webkit-user-drag:none!important;-webkit-user-select:none!important;user-select:none!important}.mobile-tag-search{width:min(54vw,280px);margin-left:6px}.mobile-tag-search .v-input__slot{min-height:38px!important;padding:0 10px!important;border:1px solid rgba(255,255,255,.14);border-radius:12px;background:rgba(255,255,255,.06)!important}.mobile-detail-nav .v-btn{width:46px!important;height:46px!important;min-width:46px!important;color:#f5f5f7!important;background:transparent!important;box-shadow:none!important}html.ym-immersive .v-app-bar,html.ym-immersive .mobile-bottom-nav{display:none!important}html.ym-immersive .v-main{padding-top:0!important;padding-bottom:0!important}html.ym-immersive .posts-image-card{border-radius:0!important}.mobile-settings-btn{flex:0 0 44px!important}.mobile-search-sheet{color:#f5f5f7!important;background:#08090c!important}.mobile-search-sheet .v-toolbar{padding-top:env(safe-area-inset-top);background:#111318!important}.mobile-search-input{margin:0 8px}.mobile-search-suggestions{padding-bottom:env(safe-area-inset-bottom);background:#08090c!important}.immersive-exit-button{position:fixed;z-index:9999;top:calc(10px + env(safe-area-inset-top));right:10px;display:flex;align-items:center;justify-content:center;width:48px;height:48px;border:1px solid rgba(255,255,255,.12);border-radius:50%;color:#fff;background:rgba(17,19,24,.78);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px)}html.ym-immersive .wf-layout,html.ym-immersive .wf-layout>div,html.ym-immersive .v-main__wrap{width:100vw!important;max-width:none!important;margin:0!important;padding:0!important}html.ym-immersive .posts-image-card{margin:0!important}@media screen and (max-width: 959px){.mobile-pop-mode{margin-left:2px!important}.mobile-pop-date{width:154px;min-width:154px}.mobile-pop-date .v-text-field{width:96px}.mobile-pop-date .v-input__prepend-outer{display:none}}.drawer-shortcuts{padding:8px!important}.drawer-shortcuts .v-list-item{min-height:52px;margin-bottom:3px;border-radius:12px}html.long-press-sharing,html.long-press-sharing body{overflow:hidden!important;overscroll-behavior:none}html.long-press-sharing body{position:fixed;right:0;left:0;width:100%}.long-press-preview{position:fixed;z-index:9998;inset:0;display:flex;align-items:center;justify-content:center;padding:max(24px,env(safe-area-inset-top)) 24px max(24px,env(safe-area-inset-bottom));pointer-events:none;background:rgba(0,0,0,.62);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px)}.long-press-preview img{display:block;max-width:86vw;max-height:74vh;border-radius:24px;object-fit:contain;box-shadow:0 24px 70px #00000094;animation:long-press-preview-in .16s ease-out}@keyframes long-press-preview-in{0%{opacity:0;transform:scale(.92)}to{opacity:1;transform:scale(1)}}:root{--ios-accent: #8e5bc7;--ios-bg: #f2f2f7;--ios-surface: #fff;--ios-surface-2: #f2f2f7;--ios-label: #000;--ios-secondary-label: #6c6c70;--ios-tertiary-label: rgba(60, 60, 67, .3);--ios-separator: rgba(60, 60, 67, .22);--ios-fill: rgba(120, 120, 128, .16);--ios-fill-strong: rgba(120, 120, 128, .24)}.theme--dark{--ios-bg: #000;--ios-surface: #1c1c1e;--ios-surface-2: #2c2c2e;--ios-label: #fff;--ios-secondary-label: #98989d;--ios-tertiary-label: rgba(235, 235, 245, .3);--ios-separator: rgba(84, 84, 88, .65);--ios-fill: rgba(118, 118, 128, .24);--ios-fill-strong: rgba(118, 118, 128, .36)}.v-application,.theme--dark.v-application{color:var(--ios-label)!important;background:var(--ios-bg)!important;font-family:-apple-system,BlinkMacSystemFont,SF Pro Text,PingFang SC,sans-serif!important}.theme--dark .v-app-bar,.theme--dark .nav_drawer,.theme--dark .settings_drawer{background:rgba(18,18,20,.94)!important;border-color:var(--ios-separator)!important;box-shadow:none!important}.theme--light .nav_drawer,.theme--light .settings_drawer{color:var(--ios-label)!important;background:rgba(255,255,255,.96)!important;border-color:var(--ios-separator)!important;box-shadow:none!important}.settings_drawer .v-list,.settings_drawer .v-list-item,.mobile-site-drawer .v-list,.mobile-site-drawer .v-list-item{background:transparent!important}.settings_drawer .v-list-item,.mobile-site-drawer .v-list-item{min-height:56px;border-radius:12px}.settings_drawer .v-list-item__subtitle,.mobile-site-drawer .v-list-item__subtitle{color:var(--ios-secondary-label)!important}.theme--dark .v-input--switch .v-input--switch__track{opacity:1!important;background:#3a3a3c!important}.theme--dark .v-input--switch.v-input--is-label-active .v-input--switch__track{background:#8e5bc7!important}.theme--dark .v-btn:before,.theme--dark .v-list-item:before{opacity:0!important}.mobile-date-filter{display:flex;flex:1 1 auto;align-items:center;min-width:0;max-width:calc(100vw - 164px);margin-left:2px;overflow:visible;white-space:nowrap}.mobile-date-filter .v-btn{min-width:34px!important;padding:0 6px!important;text-transform:none!important}.mobile-date-filter .date-mode-toggle{flex:0 0 auto;margin-right:2px;border-radius:9px;background:rgba(118,118,128,.24)!important;box-shadow:none!important}.mobile-date-filter .date-mode-toggle .v-btn{width:40px!important;min-width:40px!important;color:var(--ios-secondary-label)!important}.mobile-date-filter .date-mode-toggle .v-btn--active{color:var(--ios-label)!important;background:rgba(118,118,128,.46)!important}.mobile-date-filter .scale-button{width:34px;min-width:34px!important;font-size:15px}.mobile-date-filter .date-display{min-width:54px!important;max-width:92px;padding:0 2px!important;font-variant-numeric:tabular-nums}.native-date-trigger{position:relative;flex:0 1 auto;min-width:0}.native-date-trigger input{position:absolute;inset:0;width:100%;height:100%;margin:0;opacity:.001;cursor:pointer;-webkit-appearance:none;appearance:none}.mobile-search-fab{right:16px!important;bottom:calc(20px + env(safe-area-inset-bottom))!important;width:48px!important;height:48px!important;color:var(--ios-label)!important;background:rgba(44,44,46,.82)!important;border:1px solid var(--ios-separator)!important;box-shadow:0 8px 24px #00000047!important;backdrop-filter:blur(18px) saturate(140%);-webkit-backdrop-filter:blur(18px) saturate(140%)}.theme--light .mobile-search-fab{color:#1c1c1e!important;background:rgba(255,255,255,.84)!important}.ios-date-dialog{width:min(92vw,430px)!important;margin:0!important;align-self:flex-end}.ios-date-sheet{width:min(92vw,390px);overflow:hidden;border-radius:22px 22px 0 0!important;background:var(--ios-surface)!important}.ios-date-sheet .v-picker{width:100%!important}.ios-date-sheet .v-card__title{justify-content:center;color:var(--ios-label);font-size:17px;font-weight:600}.ios-month-picker{display:grid;gap:14px;padding:12px 20px 20px;color:var(--ios-label)}.ios-month-picker input{width:100%;min-height:44px;padding:0 12px;border:1px solid var(--ios-separator);border-radius:10px;color:inherit;background:var(--ios-surface);font:inherit;color-scheme:dark}.theme--light .ios-month-picker input{color-scheme:light}.native-range-sheet{padding-bottom:env(safe-area-inset-bottom)}.native-range-input{position:relative;padding:8px 20px 16px}.native-range-input input{width:100%;min-height:48px;padding:0 12px;border:1px solid var(--ios-separator);border-radius:12px;color:var(--ios-label);background:var(--ios-surface);font:inherit;color-scheme:dark}.theme--light .native-range-input input{color-scheme:light}.range-selection-summary{display:grid;gap:4px;padding:0 20px 8px;color:var(--ios-secondary-label);font-size:13px}.ios-year-picker{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;max-height:48vh;padding:12px;overflow:auto}.mobile-date-filter .range-display{min-width:108px!important;max-width:118px;font-size:13px}.ios-range-picker{display:grid;grid-template-columns:1fr;gap:12px;max-height:62vh;padding:0 10px 10px;overflow:auto}.ios-range-picker .v-picker{width:100%!important}.range-label{padding:8px 12px 4px;color:var(--ios-secondary-label);font-size:14px}\n';
  const langList = [
  ...
  var _sfc_main$f = /* @__PURE__ */ Vue2.defineComponent({
  ...
  var VirtualWaterfall = __component__$f.exports;
...
Make sure you have modified Tampermonkey's "Download Mode" to "Browser API".`;
  ...
  var WfLayout = __component__$e.exports;
  ...
  var mdiCalendarStar = "M19 19H5V8H19M16 1V3H8V1H6V3H5C3.9 3 3 3.9 3 5V19C3 20.11 3.9 21 5 21H19C20.11 21 21 20.11 21 19V5C21 3.9 20.11 3 19 3H18V1M10.88 12H7.27L10.19 14.11L9.08 17.56L12 15.43L14.92 17.56L13.8 14.12L16.72 12H13.12L12 8.56L10.88 12Z";
  ...
  function currentDateSite() {
    if (location.hostname === "yande.re")
      return "yandere";
    if (location.hostname === "konachan.com")
      return "konachan-com";
    if (location.hostname === "konachan.net")
      return "konachan-net";
  ...
  function currentRouteKind() {
    ...
    if (/\/post\/popular_/.test(path))
      return "popular";
    if (path === "/explore/posts/viewed")
      return "viewed";
    if (path === "/explore/posts/popular")
      return "popular";
    ...
    if (/order:random/.test(tags))
      return "random";
    if (path === "/post" || path === "/posts" || location.hostname === "gelbooru.com")
      return "home";
    return null;
  }
  function pad(value) {
  ...
  function formatDateDisplay(dateText, scale) {
    ...
    if (scale === "range")
      return dateText;
    if (scale === "day")
      return slash(range.date);
    if (scale === "week") {
      const start = slash(range.start);
      const end = slash(range.end);
      return range.start.slice(5, 7) === range.end.slice(5, 7) ? `${start}\u2013${end.slice(-2)}` : `${start}\u2013${end}`;
    }
    if (scale === "month")
      return range.date.slice(0, 7).replace("-", "/");
    ...
    if (/\/post\/popular_recent/.test(url.pathname)) {
      ...
      if (parsedTags) {
        ...
        if (parsedTags.start && parsedTags.end) {
          ...
          if (params2.get("date_scale") === "range")
            scale = "range";
        }
      }
  ...
  var _sfc_main$d = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      ...
      const showModeToggle = Vue2.computed(() => hasLatestMode.value || isHome.value);
      const showScale = Vue2.computed(() => dateFilter.mode !== "all");
      const primaryMode = Vue2.computed(() => hasLatestMode.value ? "latest" : "all");
      const primaryLabel = Vue2.computed(() => hasLatestMode.value ? routeKind === "ranked" ? "\u8FD1\u671F\u6392\u540D" : "\u6700\u8FD1\u4EBA\u6C14" : "\u5168\u90E8\u5E16\u5B50");
      const secondaryLabel = Vue2.computed(() => routeKind === "ranked" ? "\u5386\u53F2\u9AD8\u5206" : "\u6307\u5B9A\u65E5\u671F");
      const primaryIcon = Vue2.computed(() => hasLatestMode.value ? mdiFire : mdiViewGridOutline);
      const secondaryIcon = Vue2.computed(() => routeKind === "ranked" ? mdiCalendarStar : mdiCalendarMonthOutline);
      const scales = Vue2.computed(() => {
        const values = routeKind && capability ? [...capability.scales[routeKind]] : [];
        if (dateFilter.mode === "date" && (routeKind === "home" || site === "danbooru" && routeKind === "ranked"))
          values.push("range");
        return values;
      });
      const labels = { day: "\u65E5", week: "\u5468", month: "\u6708", year: "\u5E74", range: "\u8303\u56F4" };
      const scaleLabel = Vue2.computed(() => labels[dateFilter.scale]);
      const displayDate = Vue2.computed(() => formatDateDisplay(dateFilter.date, dateFilter.scale));
      const today = formatISODate(new Date());
      ...
      const rangeComplete = Vue2.computed(() => !!dateFilter.rangeStart && !!dateFilter.rangeEnd);
      const rangeDisplay = Vue2.computed(() => dateFilter.rangeStart && dateFilter.rangeEnd ? `${dateFilter.rangeStart.slice(5).replace("-", "/")}\u2013${dateFilter.rangeEnd.slice(5).replace("-", "/")}` : "\u9009\u62E9\u8303\u56F4");
      const rangeNativeValue = Vue2.computed(() => rangeStep.value === "start" ? dateFilter.rangeStart || dateFilter.date : dateFilter.rangeEnd || dateFilter.rangeStart);
      const nativePickerType = Vue2.computed(() => dateFilter.scale === "month" ? "month" : "date");
      const nativePickerValue = Vue2.computed(() => dateFilter.scale === "month" ? dateFilter.date.slice(0, 7) : dateFilter.date);
      const nativePickerMax = Vue2.computed(() => dateFilter.scale === "month" ? today.slice(0, 7) : today);
      const pickerTitle = Vue2.computed(() => dateFilter.scale === "month" ? "\u9009\u62E9\u6708\u4EFD" : dateFilter.scale === "week" ? "\u9009\u62E9\u5468\u6240\u5728\u65E5\u671F" : "\u9009\u62E9\u65E5\u671F");
      ...
      return { __sfc: true, site, routeKind, capability, visible, hasLatestMode, isHome, showModeToggle, showScale, primaryMode, primaryLabel, secondaryLabel, primaryIcon, secondaryIcon, scales, labels, scaleLabel, displayDate, today, showYearPicker, showRangePicker, rangeStep, pendingNativeValue, rangePendingValue, rangeComplete, rangeDisplay, rangeNativeValue, nativePickerType, nativePickerValue, nativePickerMax, pickerTitle, currentYear, years, canMoveNext, navigate, setScale, openRangePicker, resetRange, onRangeNativeInput, onRangeNativeChange, applyRange, move, onNativeDateInput, onNativeDateChange, onYearSelected, mdiChevronLeft, mdiChevronRight, dateFilter };
    }
  });
  var _sfc_render$d = function render() {
    ...
    }, expression: "dateFilter.mode" } }, [_c("v-btn", { attrs: { "value": _setup.primaryMode, "icon": "", "small": "", "aria-label": _setup.primaryLabel, "title": _setup.primaryLabel } }, [_c("v-icon", [_vm._v(_vm._s(_setup.primaryIcon))])], 1), _c("v-btn", { attrs: { "value": "date", "icon": "", "small": "", "aria-label": _setup.secondaryLabel, "title": _setup.secondaryLabel } }, [_c("v-icon", [_vm._v(_vm._s(_setup.secondaryIcon))])], 1)], 1) : _vm._e(), _setup.showScale ? _c("v-menu", { attrs: { "offset-y": "" }, scopedSlots: _vm._u([{ key: "activator", fn: function({ on, attrs }) {
    ...
    }), 1)], 1) : _vm._e(), _setup.dateFilter.mode === "date" ? [_setup.dateFilter.scale !== "range" ? [_c("v-btn", { attrs: { "icon": "", "small": "" }, on: { "click": function($event) {
      return _setup.move(-1);
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronLeft))])], 1), _setup.dateFilter.scale !== "year" ? _c("div", { staticClass: "native-date-trigger" }, [_c("v-btn", { staticClass: "date-display", attrs: { "small": "", "text": "", "tabindex": "-1" } }, [_vm._v(_vm._s(_setup.displayDate))]), _c("input", { attrs: { "type": _setup.nativePickerType, "max": _setup.nativePickerMax, "aria-label": _setup.pickerTitle }, domProps: { "value": _setup.nativePickerValue }, on: { "input": _setup.onNativeDateInput, "change": _setup.onNativeDateChange } })], 1) : _c("v-btn", { staticClass: "date-display", attrs: { "small": "", "text": "" }, on: { "click": function($event) {
      _setup.showYearPicker = true;
    } } }, [_vm._v(_vm._s(_setup.displayDate))]), _setup.canMoveNext ? _c("v-btn", { attrs: { "icon": "", "small": "" }, on: { "click": function($event) {
      return _setup.move(1);
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronRight))])], 1) : _vm._e()] : _c("v-btn", { staticClass: "date-display range-display", attrs: { "small": "", "text": "" }, on: { "click": _setup.openRangePicker } }, [_vm._v(_vm._s(_setup.rangeDisplay))]), _c("v-dialog", { attrs: { "content-class": "ios-date-dialog" }, model: { value: _setup.showRangePicker, callback: function($$v) {
      _setup.showRangePicker = $$v;
    }, expression: "showRangePicker" } }, [_c("v-card", { staticClass: "ios-date-sheet native-range-sheet" }, [_c("v-card-title", [_vm._v(_vm._s(_setup.rangeStep === "start" ? "\u9009\u62E9\u5F00\u59CB\u65E5\u671F" : "\u9009\u62E9\u7ED3\u675F\u65E5\u671F"))]), _c("div", { staticClass: "native-range-input" }, [_c("input", { attrs: { "type": "date", "min": _setup.rangeStep === "end" ? _setup.dateFilter.rangeStart : void 0, "max": _setup.today }, domProps: { "value": _setup.rangeNativeValue }, on: { "input": _setup.onRangeNativeInput, "change": _setup.onRangeNativeChange } })]), _c("div", { staticClass: "range-selection-summary" }, [_c("span", [_vm._v("\u5F00\u59CB\uFF1A" + _vm._s(_setup.dateFilter.rangeStart || "\u672A\u9009\u62E9"))]), _c("span", [_vm._v("\u7ED3\u675F\uFF1A" + _vm._s(_setup.dateFilter.rangeEnd || "\u672A\u9009\u62E9"))])]), _c("v-card-actions", [_c("v-btn", { attrs: { "text": "" }, on: { "click": _setup.resetRange } }, [_vm._v("\u91CD\u7F6E")]), _c("v-spacer"), _c("v-btn", { attrs: { "text": "" }, on: { "click": function($event) {
      _setup.showRangePicker = false;
    } } }, [_vm._v("\u53D6\u6D88")]), _c("v-btn", { attrs: { "text": "", "disabled": !_setup.rangeComplete }, on: { "click": _setup.applyRange } }, [_vm._v("\u67E5\u770B\u7ED3\u679C")])], 1)], 1)], 1), _c("v-dialog", { attrs: { "content-class": "ios-date-dialog" }, model: { value: _setup.showYearPicker, callback: function($$v) {
      _setup.showYearPicker = $$v;
    }, expression: "showYearPicker" } }, [_c("v-card", { staticClass: "ios-date-sheet" }, [_c("v-card-title", [_vm._v("\u9009\u62E9\u5E74\u4EFD")]), _c("div", { staticClass: "ios-year-picker" }, _vm._l(_setup.years, function(year) {
      return _c("v-btn", { key: year, attrs: { "text": "" }, on: { "click": function($event) {
        return _setup.onYearSelected(year);
      } } }, [_vm._v(_vm._s(year))]);
    }), 1), _c("v-card-actions", [_c("v-spacer"), _c("v-btn", { attrs: { "text": "" }, on: { "click": function($event) {
      _setup.showYearPicker = false;
    } } }, [_vm._v("\u53D6\u6D88")])], 1)], 1)], 1)] : _vm._e()], 2) : _vm._e();
  };
  ...
  var MobileDateFilter = __component__$d.exports;
  ...
  var _sfc_main$c = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      ...
      return { __sfc: true, isMobile: isMobile2, title, isNoSelected, isOneOrMoreSelected, isAllSelected, loadingValue, selectAll, removeFromList, tagsQuery, searchState, onSearchTermInput, selectTag, userName, fetchTaggedPosts, selectMobileTag, submitMobileSearch, showTagsInput, onSearchTermKeydown, showPopAction, periodMap, periodByDateMap, getRecentPeriod, isPopularRecent, getPopTitle, popTitle, isPopSearchByDate, recentPeriod, periodComputedMap, showPopDatePicker, popSearchDate, fetchPopularPosts, selPeriod, loadPrevPeriod, loadNextPeriod, goToPopularPage, showPool, poolQueryTerm, searchPool, download, downloadUrlKey, downloadNameMap, downloadNameKey, isGelbooru, startDownload, isExportUrlDecode, isExportUrlEncode, exportFileUrls, vuetify, toggleDarkmode, keyActions, goToPage, exitMasonry, toggleImmersive, toggleFullscreen, selectLang, mdiBrightness6, mdiCalendar, mdiCalendarSearch, mdiCheckUnderlineCircle, mdiCheckboxBlankOutline, mdiCheckboxIntermediate, mdiCheckboxMarked, mdiChevronLeft, mdiChevronRight, mdiClose, mdiCog, mdiDelete, mdiDownload, mdiFileClockOutline, mdiFire, mdiFullscreen, mdiFullscreenExit, mdiHome, mdiImageMultiple, mdiLocationExit, mdiMagnify, mdiShuffle, mdiStar, mdiTranslate, MobileDateFilter, settings, store, toggleDrawer, langList, isSupportTagSearch, notPartialSupportSite, isSankakuSite, isZerochanPage };
    }
  });
  var _sfc_render$c = function render() {
    ...
    return _c("v-app-bar", { attrs: { "app": "", "dense": "", "flat": "", "elevation": 2 } }, [_c("v-app-bar-nav-icon", { on: { "click": function($event) {
    ...
    } } }), _setup.isMobile ? _c(_setup.MobileDateFilter) : _vm._e(), !_setup.isMobile && _setup.store.isYKSite && _setup.showPopAction ? _c("div", { staticClass: "align-center", staticStyle: { "display": "flex" } }, [_c("v-toolbar-title", { staticClass: "mr-4 hidden-md-and-down", domProps: { "textContent": _vm._s(_setup.popTitle) } }), _c("v-switch", { staticClass: "hidden-sm-and-down", attrs: { "hide-details": "", "label": _setup.isPopSearchByDate ? _vm.$t("nd4UjZy2ILsc-iW9iu7xR") : _vm.$t("elkBQ9moOZ-KMcy5bt_Ts") }, model: { value: _setup.isPopSearchByDate, callback: function($$v) {
      _setup.isPopSearchByDate = $$v;
    }, expression: "isPopSearchByDate" } }), _setup.isMobile ? _c("v-btn", { staticClass: "mobile-pop-mode", attrs: { "small": "", "icon": "" }, on: { "click": function($event) {
      _setup.isPopSearchByDate = !_setup.isPopSearchByDate;
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.isPopSearchByDate ? _setup.mdiCalendar : _setup.mdiFire))])], 1) : _vm._e(), _c("v-menu", { attrs: { "transition": "slide-y-transition", "offset-y": "" }, scopedSlots: _vm._u([{ key: "activator", fn: function({ on, attrs }) {
      return [_c("v-btn", _vm._g(_vm._b({ staticClass: "ml-4", attrs: { "small": "" } }, "v-btn", attrs, false), on), [_c("v-icon", { attrs: { "left": "" } }, [_vm._v(_vm._s(_setup.mdiCalendarSearch))]), _c("span", { staticStyle: { "margin-bottom": "2px" } }, [_vm._v(_vm._s(_setup.isMobile && _setup.isPopSearchByDate ? _setup.periodComputedMap[_setup.recentPeriod][0].slice(-1) : _setup.periodComputedMap[_setup.recentPeriod][0]))])], 1)];
    } }], null, false, 2784797949) }, [_c("v-list", { attrs: { "dense": "" } }, _vm._l(_setup.periodComputedMap, function(val, key) {
      ...
      return [_c("div", { directives: [{ name: "show", rawName: "v-show", value: _setup.isPopSearchByDate, expression: "isPopSearchByDate" }], staticClass: "ml-1 align-center mobile-pop-date", staticStyle: { "display": "flex" } }, [_c("v-btn", { attrs: { "icon": "" }, on: { "click": function($event) {
        return _setup.loadPrevPeriod();
      } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronLeft))])], 1), _c("v-text-field", _vm._g(_vm._b({ attrs: { "value": _setup.isMobile ? _setup.popSearchDate.slice(5) : _setup.popSearchDate, "prepend-icon": _setup.mdiCalendar, "readonly": "", "hide-details": "" } }, "v-text-field", attrs, false), on)), _c("v-btn", { attrs: { "icon": "" }, on: { "click": function($event) {
        return _setup.loadNextPeriod();
      } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronRight))])], 1)], 1)];
    } }], null, false, 3493337328), model: { value: _setup.showPopDatePicker, callback: function($$v) {
    ...
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiShuffle))])], 1)] : _vm._e(), _setup.isMobile && _setup.isSupportTagSearch ? [_c("v-btn", { staticClass: "mobile-search-trigger", attrs: { "title": "\u641C\u7D22\u6807\u7B7E", "icon": "" }, on: { "click": function($event) {
      _setup.store.showMobileSearch = true;
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiMagnify))])], 1)] : _setup.isSupportTagSearch || _setup.isSankakuSite ? [_c("v-menu", { attrs: { "max-width": 200, "max-height": "80vh", "transition": "slide-y-transition", "nudge-bottom": "5px", "offset-y": "" }, scopedSlots: _vm._u([{ key: "activator", fn: function({ on }) {
    ...
    }), 1)], 1)], 1)] : _vm._e(), !_setup.isMobile ? _c("v-btn", { attrs: { "title": _vm.$t("u8mEnSo4mxDRUbj7FeAll"), "icon": "" }, on: { "click": _setup.toggleDarkmode } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiBrightness6))])], 1) : _vm._e(), _c("v-btn", { staticClass: "hidden-md-and-down", attrs: { "title": _vm.$t("OrwwNKZ7I70-ecpspE8d_"), "icon": "" }, on: { "click": _setup.toggleFullscreen } }, [_c("v-icon", { attrs: { "size": 30 } }, [_vm._v(_vm._s(_setup.store.isFullscreen ? _setup.mdiFullscreenExit : _setup.mdiFullscreen))])], 1), _c("v-menu", { attrs: { "transition": "slide-y-transition", "offset-y": "" }, scopedSlots: _vm._u([{ key: "activator", fn: function({ on, attrs }) {
    ...
    }), 1)], 1)], 1), _setup.isMobile ? _c("v-btn", { attrs: { "title": "\u6C89\u6D78\u6A21\u5F0F", "icon": "" }, on: { "click": _setup.toggleImmersive } }, [_c("v-icon", [_vm._v(_vm._s(_setup.store.isImmersive ? _setup.mdiFullscreenExit : _setup.mdiFullscreen))])], 1) : _vm._e(), _setup.isMobile ? _c("v-btn", { staticClass: "mobile-settings-btn", attrs: { "title": _vm.$t("UxxldE9xRwmQctrvba5Y8"), "icon": "" }, on: { "click": function($event) {
      _setup.store.showSettings = true;
    } } }, [_c("v-icon", { attrs: { "size": 22 } }, [_vm._v(_vm._s(_setup.mdiCog))])], 1) : _c("v-btn", { attrs: { "title": _vm.$t("UxxldE9xRwmQctrvba5Y8"), "icon": "" }, on: { "click": function($event) {
      _setup.store.showSettings = true;
    } } }, [_c("v-icon", { attrs: { "size": 22 } }, [_vm._v(_vm._s(_setup.mdiCog))])], 1), _c("v-btn", { staticClass: "hidden-md-and-down", attrs: { "title": _vm.$t("ClZdL9hGweOokP7Mn_Ptq"), "icon": "" }, on: { "click": _setup.exitMasonry } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiLocationExit))])], 1), _c("v-dialog", { attrs: { "fullscreen": "", "transition": "dialog-bottom-transition" }, model: { value: _setup.store.showMobileSearch, callback: function($$v) {
      _vm.$set(_setup.store, "showMobileSearch", $$v);
    }, expression: "store.showMobileSearch" } }, [_c("v-card", { staticClass: "mobile-search-sheet" }, [_c("v-toolbar", { attrs: { "flat": "" } }, [_c("v-btn", { attrs: { "icon": "" }, on: { "click": function($event) {
      _setup.store.showMobileSearch = false;
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiClose))])], 1), _c("v-text-field", { staticClass: "mobile-search-input", attrs: { "placeholder": "\u8F93\u5165\u82F1\u6587\u6807\u7B7E", "autofocus": "", "clearable": "", "hide-details": "" }, on: { "input": _setup.onSearchTermInput, "keydown": function($event) {
      if (!$event.type.indexOf("key") && _vm._k($event.keyCode, "enter", 13, $event.key, "Enter"))
        return null;
      return _setup.submitMobileSearch.apply(null, arguments);
    } }, model: { value: _setup.searchState.searchTerm, callback: function($$v) {
      _vm.$set(_setup.searchState, "searchTerm", $$v);
    }, expression: "searchState.searchTerm" } }), _c("v-btn", { attrs: { "text": "" }, on: { "click": _setup.submitMobileSearch } }, [_vm._v("\u641C\u7D22")])], 1), _setup.searchState.searchItems.length ? _c("v-list", { staticClass: "mobile-search-suggestions", attrs: { "dense": "" } }, _vm._l(_setup.searchState.searchItems, function(item) {
      return _c("v-list-item", { key: item, on: { "click": function($event) {
        return _setup.selectMobileTag(item);
      } } }, [_c("v-list-item-title", { domProps: { "textContent": _vm._s(item) } })], 1);
  ...
  var yandereIcon = "data:image/svg+xml;base64,";
  var konachanIcon = "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAzMiAzMiI+PHJlY3Qgd2lkdGg9IjMyIiBoZWlnaHQ9IjMyIiByeD0iOCIgZmlsbD0iI2Q2NWM5MSIvPjxwYXRoIGQ9Ik05IDhoNHY3bDYtN2g1bC03IDggNyA4aC01bC02LTd2N0g5eiIgZmlsbD0iI2ZmZiIvPjwvc3ZnPgo=";
  var konachanSafeIcon = "data:image/svg+xml;base64,";
  var danbooruIcon = "data:image/svg+xml;base64,";
  var gelbooruIcon = "data:image/svg+xml;base64,";
  var _sfc_main$b = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      ...
      return { __sfc: true, locationHost, isDanbooru, isGelbooru, danbooruShortcuts, gelbooruShortcuts, sites: sites2, openSite, mdiClose, mdiFire, mdiHome, mdiImageMultiple, mdiShuffle, store };
    }
  });
  var _sfc_render$b = function render() {
    ...
    return _c("v-navigation-drawer", { staticClass: "nav_drawer mobile-site-drawer", attrs: { "app": "", "temporary": "" }, model: { value: _setup.store.showDrawer, callback: function($$v) {
    ...
    } } }, [_c("v-list-item-icon", { staticClass: "mr-3" }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiImageMultiple))])], 1), _c("v-list-item-content", [_c("v-list-item-title", [_vm._v("\u56FE\u96C6")])], 1)], 1)], 1) : _vm._e(), _setup.isDanbooru ? _c("v-list", { staticClass: "drawer-shortcuts", attrs: { "dense": "", "nav": "" } }, [_c("v-subheader", [_vm._v("Danbooru \u6D4F\u89C8")]), _vm._l(_setup.danbooruShortcuts, function(item) {
      return _c("v-list-item", { key: item.url, attrs: { "link": "" }, on: { "click": function($event) {
        return _setup.openSite(item.url);
      } } }, [_c("v-list-item-icon", { staticClass: "mr-3" }, [_c("v-icon", [_vm._v(_vm._s(item.icon))])], 1), _c("v-list-item-content", [_c("v-list-item-title", [_vm._v(_vm._s(item.label))])], 1)], 1);
    })], 2) : _vm._e(), _setup.isGelbooru ? _c("v-list", { staticClass: "drawer-shortcuts", attrs: { "dense": "", "nav": "" } }, [_c("v-subheader", [_vm._v("Gelbooru \u6D4F\u89C8")]), _vm._l(_setup.gelbooruShortcuts, function(item) {
      return _c("v-list-item", { key: item.url, attrs: { "link": "" }, on: { "click": function($event) {
        return _setup.openSite(item.url);
      } } }, [_c("v-list-item-icon", { staticClass: "mr-3" }, [_c("v-icon", [_vm._v(_vm._s(item.icon))])], 1), _c("v-list-item-content", [_c("v-list-item-title", [_vm._v(_vm._s(item.label))])], 1)], 1);
    })], 2) : _vm._e(), _setup.store.isYKSite || _setup.isDanbooru || _setup.isGelbooru ? _c("v-divider") : _vm._e(), _c("v-list", { staticClass: "site-switch-list", attrs: { "dense": "", "nav": "" } }, [_c("v-subheader", [_vm._v("\u7AD9\u70B9\u5217\u8868")]), _vm._l(_setup.sites, function(site) {
      ...
      } } }, [_c("v-list-item-icon", { staticClass: "mr-3" }, [_c("img", { staticClass: "site_icon", attrs: { "src": site.icon, "loading": "lazy", "referrerpolicy": "no-referrer" } })]), _c("v-list-item-content", [_c("v-list-item-title", [_vm._v(_vm._s(site.label))]), _c("v-list-item-subtitle", [_vm._v(_vm._s(site.host))])], 1)], 1);
    })], 2)], 1);
  };
  ...
  var _sfc_main$a = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      async function exitImmersive() {
        ...
        document.documentElement.classList.remove("ym-immersive");
        if (document.fullscreenElement) {
          try {
            await document.exitFullscreen();
          } catch (_error) {
      ...
      return { __sfc: true, exitImmersive, mdiFullscreenExit, store };
    }
  });
  var _sfc_render$a = function render() {
    var _vm = this, _c = _vm._self._c, _setup = _vm._self._setupProxy;
    return _setup.store.isImmersive ? _c("button", { staticClass: "immersive-exit-button", attrs: { "type": "button", "aria-label": "\u9000\u51FA\u6C89\u6D78\u6A21\u5F0F" }, on: { "click": _setup.exitImmersive } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiFullscreenExit))])], 1) : _vm._e();
  };
  ...
  var ImmersiveExit = __component__$a.exports;
  var _sfc_main$9 = /* @__PURE__ */ Vue2.defineComponent({
    __name: "MobileSearchFab",
    setup(__props) {
      const isMobile2 = window.matchMedia("(max-width: 959px), (pointer: coarse)").matches;
      const visible = Vue2.computed(() => isMobile2 && isSupportTagSearch && store.showPostList && !store.showImageSelected && !store.showDrawer && !store.showSettings && !store.showMobileSearch && !store.isImmersive);
      return { __sfc: true, isMobile: isMobile2, visible, mdiMagnify, store };
    }
  });
  var _sfc_render$9 = function render() {
    var _vm = this, _c = _vm._self._c, _setup = _vm._self._setupProxy;
    return _c("v-fab-transition", [_c("v-btn", { directives: [{ name: "show", rawName: "v-show", value: _setup.visible, expression: "visible" }], staticClass: "mobile-search-fab", attrs: { "fixed": "", "fab": "", "aria-label": "\u641C\u7D22\u6807\u7B7E" }, on: { "click": function($event) {
      _setup.store.showMobileSearch = true;
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiMagnify))])], 1)], 1);
  };
  ...
  var MobileSearchFab = __component__$9.exports;
  ...
  var _sfc_main$5 = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      ...
      const imgLasySrc = Vue2.computed(() => {
        if (isVideo.value)
          return void 0;
        return imageSelected.value.previewUrl ?? imageSelected.value.sampleUrl ?? imageSelected.value.fileUrl ?? void 0;
      });
      ...
      function onTouchStart(ev) {
        if (!isMobile2 || ev.touches.length !== 1 || scaleOn.value)
          return;
      ...
      function onTouchEnd(ev) {
        if (!isMobile2 || scaleOn.value || !touchStartedAt)
          return;
        ...
        if (dy > 96 && Math.abs(dy) > Math.abs(dx) * 1.35)
          close();
      }
      function close() {
      ...
      const sourceName = Vue2.computed(() => sourceLabel(validSourceUrl.value));
  ...
  var _sfc_render$5 = function render() {
    ...
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronRight))])], 1)], 1), _setup.isMobile && _setup.store.showImageSelected && _setup.showImageToolbar ? _c("div", { staticClass: "mobile-detail-nav", on: { "click": function($event) {
      $event.stopPropagation();
    } } }, [_c("v-btn", { attrs: { "icon": "", "aria-label": "\u4E0A\u4E00\u5F20" }, on: { "click": _setup.showPrevPost } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronLeft))])], 1), _c("v-btn", { attrs: { "icon": "", "aria-label": "\u4E0B\u8F7D\u539F\u56FE" }, on: { "click": function($event) {
      return _setup.download(_setup.imageSelected.fileUrl, _setup.imageSelected.fileDownloadName);
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiDownload))])], 1), _c("v-btn", { attrs: { "icon": "", "aria-label": "\u5206\u4EAB\u5E16\u5B50\u94FE\u63A5" }, on: { "click": function($event) {
      return _setup.sharePost(_setup.imageSelected);
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiShareVariant))])], 1), _c("v-btn", { attrs: { "icon": "", "disabled": !_setup.validSourceUrl, "aria-label": `\u5206\u4EAB\u6765\u6E90 ${_setup.sourceName}` }, on: { "click": _setup.shareSource } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiLaunch))])], 1), _c("v-btn", { attrs: { "icon": "", "aria-label": "\u4E0B\u4E00\u5F20" }, on: { "click": _setup.showNextPost } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronRight))])], 1)], 1) : _vm._e(), _setup.isExportTagsEnable && _setup.store.showImageSelected ? _c(_setup.PostExportTags, { attrs: { "show-dialog": _setup.isExportTagsShow, "update-show-dialog": (val) => _setup.isExportTagsShow = val, "tags": _setup.postDetail?.tags || [] } }) : _vm._e()], 1);
  };
  ...
  var _sfc_main$4 = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      ...
      function lockLongPressScroll() {
        if (document.documentElement.classList.contains("long-press-sharing"))
          return;
  ...
  var _sfc_main = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      ...
      return { __sfc: true, vuetify, AppBar, NavDrawer, ImmersiveExit, MobileSearchFab, SettingsDrawer, AppContainer };
    }
  });
  var _sfc_render = function render() {
    var _vm = this, _c = _vm._self._c, _setup = _vm._self._setupProxy;
    return _c("v-app", [_c(_setup.AppBar), _c(_setup.NavDrawer), _c(_setup.ImmersiveExit), _c(_setup.MobileSearchFab), _c("v-main", { attrs: { "app": "" } }, [_c(_setup.AppContainer), _c(_setup.SettingsDrawer)], 1)], 1);
  };
