...
.calendar-day.is-disabled[data-v-7b54b917] { opacity: .22;
  ...
  var _sfc_main$g = /* @__PURE__ */ Vue2.defineComponent({
  ...
  var VirtualWaterfall = __component__$g.exports;
...
Make sure you have modified Tampermonkey's "Download Mode" to "Browser API".`;
  ...
  var WfLayout = __component__$f.exports;
  ...
  var MobileCalendarGrid = __component__$e.exports;
  ...
  function buildDateRoute(input) {
    ...
    if (input.mode === "date" && scale === "range") {
      ...
      if (site === "yandere" || site.startsWith("konachan"))
        return `${moeOrigin(site)}/post?tags=${encodedTags(tags)}&_wf=1`;
      if (site === "danbooru") {
        const order2 = kind === "ranked" ? "order:score " : "";
        return `https://danbooru.donmai.us/posts?tags=${encodedTags(`${order2}${tags}`)}&_wf=1`;
      }
    }
    if (input.mode === "all") {
      if (site === "yandere")
  ...
  var _sfc_main$d = /* @__PURE__ */ Vue2.defineComponent({
    ...
    setup(__props) {
      ...
      const allowRange = Vue2.computed(() => dateFilter.mode === "date" && (routeKind === "home" || site === "danbooru" && routeKind === "ranked"));
      ...
      const pickerMonth = Vue2.ref(dateFilter.date.slice(0, 7));
      const rangeStep = Vue2.ref("start");
      const rangeSelection = Vue2.ref(dateFilter.rangeStart || dateFilter.date);
      const rangeComplete = Vue2.computed(() => !!dateFilter.rangeStart && !!dateFilter.rangeEnd);
      const pickerTitle = Vue2.computed(() => dateFilter.scale === "range" ? rangeStep.value === "start" ? "\u9009\u62E9\u5F00\u59CB\u65E5\u671F" : "\u9009\u62E9\u7ED3\u675F\u65E5\u671F" : { day: "\u9009\u62E9\u65E5\u671F", week: "\u9009\u62E9\u5468\u6240\u5728\u65E5\u671F", month: "\u9009\u62E9\u6708\u4EFD", year: "\u9009\u62E9\u5E74\u4EFD" }[dateFilter.scale]);
      ...
      return { __sfc: true, site, routeKind, capability, visible, hasLatestMode, isHome, showModeToggle, showScale, primaryMode, primaryLabel, secondaryLabel, primaryIcon, secondaryIcon, allowRange, scales, labels, scaleLabel, displayDate, rangeDisplay, today, showPicker, pickerMonth, rangeStep, rangeSelection, rangeComplete, pickerTitle, currentYear, years, canMoveNext, openPicker, resetRange, onRangeSelected, applyRange, navigate, setScale, move, onDateSelected, onMonthSelected, onYearSelected, mdiChevronLeft, mdiChevronRight, MobileCalendarGrid, dateFilter };
    }
  });
  var _sfc_render$d = function render() {
    ...
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronLeft))])], 1), _c("v-btn", { staticClass: "date-display", attrs: { "small": "", "text": "" }, on: { "click": _setup.openPicker } }, [_vm._v(_vm._s(_setup.displayDate))]), _setup.canMoveNext ? _c("v-btn", { attrs: { "icon": "", "small": "" }, on: { "click": function($event) {
      return _setup.move(1);
    } } }, [_c("v-icon", [_vm._v(_vm._s(_setup.mdiChevronRight))])], 1) : _vm._e()] : _c("v-btn", { staticClass: "date-display range-display", attrs: { "small": "", "text": "" }, on: { "click": _setup.openPicker } }, [_vm._v(_vm._s(_setup.rangeDisplay))]), _c("v-dialog", { attrs: { "content-class": "ios-date-dialog" }, model: { value: _setup.showPicker, callback: function($$v) {
      _setup.showPicker = $$v;
    }, expression: "showPicker" } }, [_c("v-card", { staticClass: "ios-date-sheet" }, [_c("v-card-title", [_vm._v(_vm._s(_setup.pickerTitle))]), _setup.dateFilter.scale === "day" || _setup.dateFilter.scale === "week" ? _c(_setup.MobileCalendarGrid, { attrs: { "max": _setup.today }, on: { "select": _setup.onDateSelected }, model: { value: _setup.dateFilter.date, callback: function($$v) {
      _vm.$set(_setup.dateFilter, "date", $$v);
    }, expression: "dateFilter.date" } }) : _setup.dateFilter.scale === "range" ? _c(_setup.MobileCalendarGrid, { attrs: { "max": _setup.today, "min": _setup.rangeStep === "end" ? _setup.dateFilter.rangeStart : void 0 }, on: { "select": _setup.onRangeSelected }, model: { value: _setup.rangeSelection, callback: function($$v) {
      _setup.rangeSelection = $$v;
    }, expression: "rangeSelection" } }) : _setup.dateFilter.scale === "month" ? _c("div", { staticClass: "ios-month-picker" }, [_c("label", { attrs: { "for": "mobile-month-input" } }, [_vm._v("\u9009\u62E9\u6708\u4EFD")]), _c("input", { directives: [{ name: "model", rawName: "v-model", value: _setup.pickerMonth, expression: "pickerMonth" }], attrs: { "id": "mobile-month-input", "type": "month", "max": _setup.today.slice(0, 7) }, domProps: { "value": _setup.pickerMonth }, on: { "input": function($event) {
      if ($event.target.composing)
        return;
      _setup.pickerMonth = $event.target.value;
    } } }), _c("v-btn", { attrs: { "text": "" }, on: { "click": function($event) {
      return _setup.onMonthSelected(_setup.pickerMonth);
    } } }, [_vm._v("\u67E5\u770B\u7ED3\u679C")])], 1) : _c("div", { staticClass: "ios-year-picker" }, _vm._l(_setup.years, function(year) {
      return _c("v-btn", { key: year, attrs: { "text": "" }, on: { "click": function($event) {
        return _setup.onYearSelected(year);
      } } }, [_vm._v(_vm._s(year))]);
    }), 1), _setup.dateFilter.scale === "range" ? _c("div", { staticClass: "range-selection-summary" }, [_c("span", [_vm._v("\u5F00\u59CB\uFF1A" + _vm._s(_setup.dateFilter.rangeStart || "\u672A\u9009\u62E9"))]), _c("span", [_vm._v("\u7ED3\u675F\uFF1A" + _vm._s(_setup.dateFilter.rangeEnd || "\u672A\u9009\u62E9"))])]) : _vm._e(), _c("v-card-actions", [_setup.dateFilter.scale === "range" ? _c("v-btn", { attrs: { "text": "" }, on: { "click": _setup.resetRange } }, [_vm._v("\u6E05\u9664")]) : _vm._e(), _c("v-spacer"), _c("v-btn", { attrs: { "text": "" }, on: { "click": function($event) {
      _setup.showPicker = false;
    } } }, [_vm._v("\u53D6\u6D88")]), _setup.dateFilter.scale === "range" ? _c("v-btn", { attrs: { "text": "", "disabled": !_setup.rangeComplete }, on: { "click": _setup.applyRange } }, [_vm._v("\u67E5\u770B\u7ED3\u679C")]) : _vm._e()], 1)], 1)], 1)] : _vm._e()], 2) : _vm._e();
  };
