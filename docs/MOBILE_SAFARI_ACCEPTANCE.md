...
- [x] URL 状态恢复基础参数
- [x] 站点能力动态显示
- [x] 自绘 7×6 单月历替换不稳定的 `v-date-picker`（提交 `b9b7dca`）
- [x] 自定义范围使用同一月历分两步选择的代码流程
- [x] 云端 lint/日期测试/build 成功（run `29142352766`）
- [ ] Yande.re / Konachan 完整月历 Stay 可见
- [ ] Danbooru 完整月历 Stay 稳定可见
- [ ] 自定义开始/结束日期范围 Stay 可操作
- [ ] 范围路由实际返回目标日期帖子
- [ ] 顶部周范围不遮挡全屏与设置
- [ ] 右下角悬浮搜索 Stay 实机验收
- [ ] Stay 阶段 2 总验收
